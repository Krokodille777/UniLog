...
color: #2362a5;
"> UniLog </h1> 
<p style = "text-align:center; font-size: 18px; padding: 10px; color: #7f8c8d;">A small Python app which demonstrates usage of logic binary operations.</p>

<hr>

<h2 style = "text-align:center; font-size: 24px; color: #2362a5;">🔎 About Unilog!</h2>

<p style = "text-align:center; font-size: 18px; padding: 10px; color: #7f8c8d;">If you ever wanted to see how bitwise operations work, Unilog is surely a great place for you!
<br>An easy-to-use interface makes it simple to understand and experiment with binary logic operations. Every calculation is displayed in both binary and decimal formats for better understanding. So you won't regret using it!</p>
...
Before you get started with UniLog, make sure you have these requirements met:</p>
<ul style = "font-size: 18px; color: #7f8c8d;">
...
<p style = "text-align:center; font-size: 18px; padding: 10px; color: #7f8c8d;">Here is a screenshot of the UniLog application in action:</p>
